            ...
            <div class="container">
                ...
                <div class="row mt-5">
                    <div class="col-12 col-lg-9 col-xl-9 col-xxl-9 mx-auto">
                        <!-- Alert Messages -->
                        <?php
                        if (isset($_SESSION['delete_subscriber'])) {
                            echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                ' . $_SESSION["delete_subscriber"] . '
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                              </div>';
                            unset($_SESSION["delete_subscriber"]);
                        }

                        if (isset($_SESSION["delete_subscriber_fail"])) {
                            echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                ' . $_SESSION["delete_subscriber_fail"] . '
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                              </div>';
                            unset($_SESSION["delete_subscriber_fail"]);
                        }
                        ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="../controller/subscribers_handle.php" method="POST">
                                                ...
                                                <button name="del_subscriber" class="btn btn-danger">Delete</button>
                                            </form>
                        ...
                        <div class="text-center">
                            <a href="./deleted_subscribers.php"><button class="btn btn-secondary">Deleted Subscribers</button></a>
                        </div>
                    </div>
                </div>
            </div>
