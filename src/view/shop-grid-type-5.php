                ...
                <div class="card-body p-2">
                  <div class="d-flex align-items-center justify-content-between bg-light p-2">
                     ...
                     <div class="view-type hstack gap-2 d-none d-xl-flex">
                      <p class="mb-0">Grid</p>
                      <div>
                        <a href="shop-grid.php" class="grid-type-3 d-flex gap-1">
                          <span></span>
                          <span></span>
                          <span></span>
                        </a>
                      ...
                      <div>
                        <a href="shop-grid-type-5.php" class="grid-type-3 d-flex gap-1 active">
                        <span></span>
                        <span></span>
                        <span></span>
                        <span></span>
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-5 g-4">
                  ...
                  <div class="col">
                    <div class="card border shadow-none">
                      ...
                      <div class="card-body border-top">
                        <h6 class="mb-0 fw-bold product-short-title">Syndrona</h6>
                        <p class="mb-0 product-short-name">Color Printed Kurta</p>
                        <div class="product-price d-flex align-items-center gap-2 mt-2">
                          <div class="h6 fw-bold">$458</div>
                          <div class="h6 fw-light text-muted text-decoration-line-through">$2089</div>
