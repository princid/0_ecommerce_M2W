    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-12 col-xl-12">
          ...
          <?php
          $cat_id = $_GET['cat_id'];
          $fetch = "SELECT * FROM `products_table` WHERE category_id='$cat_id' AND isDeleted = 0";
          ...
          <div class="shop-right-sidebar">
            ...
            <div class="product-grid mt-4">
              <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-5">
                ...
                <?php foreach ($data_rows as $products) {
                  $product_img = $products['featured_product_image'];
                  $product_id = $products['id'];
                  ?>
                  <div class="col">
                    <div style="height: 360px;" class="card border shadow-none">
                      <div class="position-relative overflow-hidden">
                        ...
                        <a href="./product-details.php?product_id=<?php echo $product_id ?>">
                          <img
                            src='<?php echo "../../shopingo_admin2-rahul/assets/images/product_featured_images/$product_img" ?>'
                            style="height: 250px; width:300px; " class="card-img-top" alt="...">
                        </a>
                      </div>
