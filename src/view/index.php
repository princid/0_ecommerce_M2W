...
<div class="page-content">
              ...
              <div class="position-relative overflow-hidden">
                ...
                <a href="product-details.php?product_id=<?php echo $product_id ?>">
                  <img style="height: 200px; width:100%"
                    src='<?php echo "../../shopingo_admin2-rahul/assets/images/product_featured_images/$featured_img" ?>'
            ...
            <div class="card">
              <div class="card-body">
                <div class="overflow-hidden">
                  <img src="../../assets/images/favicon-32x32.webp" class="card-img-top img-fluid rounded-0" alt="...">
                </div>
  ...
  <section class="section-padding">
    <div class="container">
      <div class="text-center pb-3">
        <h3 class="mb-0 h3 fw-bold">Brands We Support</h3>
        <p class="mb-0 text-capitalize">Shop With Your Favourite Brand</p>
      </div>
      <div class="brands">
